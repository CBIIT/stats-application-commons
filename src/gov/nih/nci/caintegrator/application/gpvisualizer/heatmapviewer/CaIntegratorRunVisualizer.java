...
public class CaIntegratorRunVisualizer {
    ...
    public void run() throws IOException, Exception {
        ...
        if (DEBUG) {
            System.out.println("runVisualizer: " + (String) params.get(CaIntegratorRunVisualizerConstants.NAME) + " starting");
        }
        ...
        // or remote
        params.put(CaIntegratorRunVisualizerConstants.LIBDIR, libdir + File.separator);
        ...
        if (DEBUG)
            System.out.println("runVisualizer: " + (String) params.get(CaIntegratorRunVisualizerConstants.NAME) + " done");
    }
    ...
    protected String[] doCommandLineSubstitutions() throws IOException {
        ...
        String commandLine = (String) params.get(CaIntegratorRunVisualizerConstants.COMMAND_LINE);
    ...
    protected String downloadSupportFiles() throws IOException {
        ...
        String name = (String) params.get(CaIntegratorRunVisualizerConstants.NAME);
        String lsid = (String) params.get(CaIntegratorRunVisualizerConstants.LSID);
    ...
    protected boolean validateCPU() throws Exception {
        String expected = (String) params.get(CaIntegratorRunVisualizerConstants.CPU_TYPE);
        String taskName = (String) params.get(CaIntegratorRunVisualizerConstants.NAME);
    ...
    protected boolean validateOS() throws Exception {
        String expected = (String) params.get(CaIntegratorRunVisualizerConstants.OS);
        String taskName = (String) params.get(CaIntegratorRunVisualizerConstants.NAME);
    ...
    protected HashMap downloadInputURLs() throws IOException {
        ...
        StringTokenizer stDownloadables = new StringTokenizer((String) params
                .get(CaIntegratorRunVisualizerConstants.DOWNLOAD_FILES), ",");
        String name = (String) params.get(CaIntegratorRunVisualizerConstants.NAME);
    ...
    public static void main(String[] args) {
        String[] wellKnownNames = { CaIntegratorRunVisualizerConstants.NAME, CaIntegratorRunVisualizerConstants.COMMAND_LINE,
